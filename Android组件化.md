# 组件化
* [Android框架篇—— 从零开始搭建一个完善的MVP开发框架(五)，通过组件化开发优化项目的结构](http://tangpj.com/2016/11/27/mvp-structure-five/)
* [Android组件化开发实践](http://www.jianshu.com/p/186fa07fc48a)
* [从零开始的Android新项目11 - 组件化实践](http://blog.zhaiyifan.cn/2016/10/20/android-new-project-from-0-p11/)
* [组件化架构漫谈](https://gold.xitu.io/entry/57ee1efe2e958a00554132bb)
